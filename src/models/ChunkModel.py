...
class ChunkModel(BaseDataModel):
    ...
    async def insert_many_chunks(self, chunks: list[DataChunk], batch_size: int=60):
    ...
    async def get_project_chunks(self, project_id: ObjectId, page_no: int =1, page_size: int =50) -> Any:
